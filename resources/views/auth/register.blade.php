            ...
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="glassmorphism card-signin my-5">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h5 class="card-title text-center">Système d'information de l'entreprise</h5>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-label-group">
                                        ...
                                        <label for="password_konfirmasi">Confirmation password</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 d-flex justify-content-center">
                                    <button class="btn btn-lg btn-primary text-white btn-block text-uppercase"
                                        type="submit">Lister</button>
                                </div>
                            </div>
                            <hr class="my-4">
                            <p class="text-center">Vous avez déjà un compte? <a href="/login">Entrer</a></p>
                        </form>
                    </div>
                </div>
            </div>
