                ...
                <div class="row mb-3">
                    <div class="col-lg-6">
                        <div class="card shadow-sm border" style="border-radius: 0.5rem">
                            <div class="card-body">
                                <h5>{{ count($transactions) }} Invités ce jour</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                                ...
                                <table class="table table-hover table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Name</th>
                                            <th>Room</th>
                                            <th class="text-center">Rester</th>
                                            <th>Jour restant</th>
                                            <th>
Dette</th>
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                ...
                                                Il n'y a pas de données dans ce tableau
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                        ...
                        <div class="card shadow-sm border">
                            <div class="card-header border-0">
                                <div class="d-flex justify-content-between">
                                    <h3 class="card-title">Tableau mensuel des invités</h3>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <p class="d-flex flex-column">
                                        {{-- <span class="text-bold text-lg">Pas encore</span> --}}
                                        {{-- <span>Nombre total d'invités à {{ Helper::thisMonth() . '/' . Helper::thisYear() }}</span> --}}
                                    </p>
                                    {{-- <p class="ml-auto d-flex flex-column text-right">
                                    <span class="text-success">
                                        <i class="fas fa-arrow-up"></i> Pas encore
                                    </span>
